...
public class PageInterceptor implements Interceptor {
    ...
    public Object intercept(Invocation invocation) throws Throwable {
        ...
        if (!dialect.skip(ms, parameterObject, rowBounds)) {
            try {
                return doPageIntercept((Executor) invocation.getTarget(), ms, parameterObject, rowBounds, (ResultHandler) args[3]);
            } finally {
                dialect.afterAll();
            }
        } else {
     ...
     * @throws Throwable
     */
    public Object doPageIntercept(Executor executor, MappedStatement ms, Object parameterObject, RowBounds rowBounds, ResultHandler resultHandler) throws Throwable {
        ...
        if (dialect.beforePage(ms, parameterObject, rowBounds)) {
            ...
            //执行分页查询
            list = executor.query(ms, parameterObject, RowBounds.DEFAULT, resultHandler, pageKey, pageBoundSql);
        } else {
            list = new ArrayList();
        }
