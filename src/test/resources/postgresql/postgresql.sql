...
create DATABASE pagehelper OWNER pagehelper;

GRANT ALL PRIVILEGES ON DATABASE pagehelper to pagehelper;

CREATE TABLE country ( id SERIAL, countryname varchar(50) DEFAULT NULL, countrycode varchar(50) DEFAULT NULL,PRIMARY KEY (Id));

ALTER TABLE country OWNER TO pagehelper;
